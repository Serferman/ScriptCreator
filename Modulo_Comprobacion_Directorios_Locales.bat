...
REM call Modulo_Comprobacion_Letra_Unidad_Local.bat
REM ESTE SCRIPT DEVUELVE UNA VARIABLE LLAMADA --------- %LETRA_UNIDAD_LOCAL% ---------
echo %LETRA_UNIDAD_LOCAL%

SET RUTA_COMPLETA=%LETRA_UNIDAD_LOCAL%
SET CONT=0

:tag_58_nuevo_array

dir %RUTA_COMPLETA% > Letra_Carpeta.txt
...
:tag_53_otra_carpeta_local
    ...
    :tag_56_primer_enlace_carpeta
        ...
        SET RUTA_COMPLETA=%LETRA_UNIDAD%\%CARPETAS_VALUE_ESPACIOS_FILTRADO%
        SET /a CONT +=1
    ...
    :tag_57_siguientes_enlaces_carpetas
        ...
        CALL SET "CARPETAS_VALUE_ESPACIOS_FILTRADO=%%CARPETAS[%CARPETA_LOCAL%]%%"
        echo %CARPETAS_VALUE_ESPACIOS_FILTRADO%
        CALL SET RUTA_COMPLETA=%RUTA_COMPLETA%\%CARPETAS_VALUE_ESPACIOS_FILTRADO%
        echo %RUTA_COMPLETA%  
